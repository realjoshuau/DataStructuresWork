public class MyDLinkedList<T extends Comparable<T>> {
    ...
    public MyDLinkedList<T> split() {
        ...
        MyDLinkedList<T> right = new MyDLinkedList<>();

        while (middle != null) {
            Node<T> next = middle.getNext();
            right.append(this.remove(middle).getData());
            middle = next;
        }
    ...
    public void merge(MyDLinkedList<T> left, MyDLinkedList<T> right) {
        ...
        while (leftCurrent != null && rightCurrent != null) {
            if (leftCurrent.getData().compareTo(rightCurrent.getData()) < 0) {
                this.append(leftCurrent.getData());
                leftCurrent = leftCurrent.getNext();
            } else {
                this.append(rightCurrent.getData());
    ...
    public void mergeSort() {
        ...
        MyDLinkedList<T> right = this.split();
        this.mergeSort();
        right.mergeSort();
